...
const ProductCard = () => {
  return (
    <div className="group my-10 flex w-full max-w-xs flex-col justify-center overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
          ...
          <a href="#" className="flex items-center justify-center rounded-md bg-orange-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-orange-300 duration-150 focus:outline-none focus:ring-4 focus:ring-blue-300">
